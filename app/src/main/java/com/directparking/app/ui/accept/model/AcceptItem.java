...
public class AcceptItem {
    ...
    public AcceptItem(String id, String user_id, String schedule_date, String schedule_time,
                      ...
                      String username, String pic, String fname, String lname, String parking_no,int rating) {
        this.id = id;
