package com.directparking.app.ui.custom.country;
...
//        Log.d(TAG, "Applying custom property");
        ...
        try {
            ...
            if (isInEditMode()) {
                ...
                contentColor = a.getColor(R.styleable.CountryCodePicker_contentColor, context.getResources().getColor(R.color.black));
            }
            if (contentColor != 0) {
